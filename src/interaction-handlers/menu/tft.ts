    ...
    return new Promise((resolve) => {
        actionRowBuilder.addComponents(
            new StringSelectMenuBuilder()
                .setCustomId(`menu:tft_a_${data?.join(",")}`)
                .setPlaceholder(
                ...
                .setOptions(
                    {
                        label: "Pase TFT",
                        emoji: "1222591967645667399", // 1
                        value: "pasetft:HIM",
                    },
                    {
                        label: "Aspecto Arena TFT",
                        emoji: "1222595790170488832", // 2
                        value: "arena:HIM",
                    },
                    {
                        label: "Estratega 750 RP",
                        emoji: "1222595790170488832", // 3
                        value: "est750:HIM",
                    },
                    {
                        label: "Estratega 925 RP",
                        emoji: "1222595790170488832", // 3
                        value: "est925:HIM",
                    },
                    {
                    ...
                    await interaction.update({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(
                                    "Has seleccionado el **Pase de TFT**. Ahora por favor escribe tu \`RiotID\` con su respectivo \`#\`, por ejemplo \`Ahri#RPHub\`. "
                                )
                            ...
                            imageCollector.on("collect", async (message) => {
                               ...
                               const attachmentURL = attachment?.url;
                                ...
                                await shortenURL(cloudinaryImage).then(async (shortURL) => {
                                    ...
                                    await module2.build(botone, { disabled: false, author: interaction.user.id }, [`${interaction.user.id}`, `${name}`, `${selectedOption}`, `${shortURL}`, `${UniqueID}`, `tf`]
                                    );
                    ...
                    await interaction.update({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(
                                    "Has seleccionado `Arena TFT`. Ahora por favor escribe tu \`RiotID\` con su respectivo \`#\`, por ejemplo \`Ahri#RPHub\`. "
                                )
                                .setColor(Colors.Success),
                        ],
                        components: [],
                    ...
                    nameCollector.on("end", async (collected, reason) => {
                        if (reason === "time") {
                            ...
                            const SkinEmbed = new EmbedBuilder()
                                ...
                                .setDescription(
                                    `Perfecto, tu nombre de invocador es \`${name}\`. Ahora, escribe por favor el nombre de la Arena que deseas adquirir.`
                                )
                                .setColor(Colors.Success);
                            ...
                            SkinCollector.on("end", async (collected, reason) => {
                                if (reason === "time") {
                                    ...
                                    const NameEmbed = new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            `Perfecto, tu nombre de invocador es \`${name}\` y la Arena que deseas adquirir es \`${skin}\`. Ahora, envía el comprobante de pago como una imagen. ${Emojis.General.Success}\nRecuerda que puedes pagar por **Nequi** <:nequi:1134763235522924596>, **Bancolombia** <:bancolombia:1134763479925010518> o por **PayPal** <:paypal:1134763669855678546>.`
                                        )
                                        .setColor(Colors.Success);
                    ...
                    await interaction.update({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(
                                    "Has seleccionado **Estratega 750 RP**. Ahora por favor escribe tu \`RiotID\` con su respectivo \`#\`, por ejemplo \`Ahri#RPHub\`. "
                                )
                                .setColor(Colors.Success),
                        ],
                        components: [],
                    ...
                    await interaction.update({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(
                                    "Has seleccionado **Estratega 925 RP**. Ahora por favor escribe tu \`RiotID\` con su respectivo \`#\`, por ejemplo \`Ahri#RPHub\`. "
                                )
                                .setColor(Colors.Success),
                        ],
                        components: [],
                    ...
                    await interaction.update({
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription(
                                    "Has seleccionado `Chibi TFT`. Ahora por favor escribe tu \`RiotID\` con su respectivo \`#\`, por ejemplo \`Ahri#RPHub\`. "
                                )
                                .setColor(Colors.Success),
                        ],
                        components: [],
                    ...
                    nameCollector.on("end", async (collected, reason) => {
                        if (reason === "time") {
                            ...
                            const SkinEmbed = new EmbedBuilder()
                                ...
                                .setDescription(
                                    `Perfecto, tu nombre de invocador es \`${name}\`. Ahora, escribe por favor el nombre del chibi que deseas adquirir.`
                                )
                                .setColor(Colors.Success);
                            ...
                            SkinCollector.on("end", async (collected, reason) => {
                                if (reason === "time") {
                                    ...
                                    const NameEmbed = new EmbedBuilder()
                                        ...
                                        .setDescription(
                                            `Perfecto, tu nombre de invocador es \`${name}\` y el chibi que deseas adquirir es \`${skin}\`. Ahora, envía el comprobante de pago como una imagen. ${Emojis.General.Success}\nRecuerda que puedes pagar por **Nequi** <:nequi:1134763235522924596>, **Bancolombia** <:bancolombia:1134763479925010518> o por **PayPal** <:paypal:1134763669855678546>.`
                                        )
                                        .setColor(Colors.Success);
